      ...
      <div class="login-right">
        <div class="login-box">
          <div class="login-header">
            <h2>欢迎回来</h2>
            <p class="guardian-text">夜深了，系统管家为您值守库存。</p>
          </div>
...
const focusState = ref('idle'); // idle, username, password
...
.login-btn {
  ...
  &:hover {
    ...
    background: linear-gradient(135deg, #66b1ff 0%, #4ce4ef 100%);
  }
